package com.guojie.tools.guide;
...
import com.guojie.tools.MainActivity;
import com.guojie.tools.R;
import com.guojie.tools.banner.BannerActivity;
import com.guojie.tools.coordinatorLayout.Coordinator1Acitvity;
import com.guojie.tools.coordinatorLayout.CoordinatorActivity;
import com.guojie.tools.headerviewadapter.MyRecyclerViewActivity;
import com.guojie.tools.letterSide.RightHintActivity;
import com.guojie.tools.percentage.PercentageActivity;
...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_start:
            case R.id.btn_back:
                startActivity(new Intent(this, Coordinator1Acitvity.class));
                finish();
                break;
        }
    }
